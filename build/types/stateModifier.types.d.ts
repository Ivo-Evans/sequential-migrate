...
export declare type StateModifier = (config: RuntimeConfiguration, stateItem: RecordedStateItem, stateScript: StateScript, lastItem: LastMigrationResult) => Promise<LastMigrationResult>;
