...
const getStatus = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const containsMissing = inferredState.some(({ status }) => status === types_1.MIGRATION_STATUS.MISSING);
    const containsSkipped = inferredState.some(({ status }) => status === types_1.MIGRATION_STATUS.SKIPPED);
